...
CubeDialog 弹出一个对话框，适合需要定制性更大的场景。
...
<Cube-Dialog title="收货地址" :visible.sync="dialogTableVisible">
...
<Cube-Dialog title="收货地址" :visible.sync="dialogFormVisible">
  <el-form :model="form">
...
<template>
  ...
  <Cube-Dialog title="外层 Dialog" :visible.sync="outerVisible">
    <Cube-Dialog
      width="30%"
      title="内层 Dialog"
