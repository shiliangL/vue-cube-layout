      ...
      if (!global.BMap) {
        ...
        global.BMap._preloader = new Promise((resolve, reject) => {
          global._initBaiduMap = function () {
            ...
            // setTimeout(_ => {
            //   // DrawingManager_min
            //   const $drScript = document.createElement('script')
            //   global.document.body.appendChild($drScript)
            //   $drScript.src = `http://api.map.baidu.com/library/DrawingManager/1.4/src/DrawingManager_min.js`
            // }, 0)
