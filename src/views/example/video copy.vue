  ...
  <div class="permissions">
    ...
    <div v-if="false" ref="code" class="flex-box">
      ...
      <div class="playerTools">
        ...
        <div class="playerTool-item flex-box">
          <el-button type="primary" @click="createPlayer">创建连接</el-button>
          <el-button type="primary" @click="openLive">播放实时</el-button>
          <el-button type="primary" @click="destroy">断开连接（销毁）</el-button>
        </div>

        <div class="playerTool-item flex-box">
          <el-button type="primary" @click="openSpeak">开启对讲机</el-button>
          <el-button type="primary" @click="closeSpeak">关闭对讲机</el-button>
        </div>
        ...
        <div>
          <div class="playerTool-item">
            ...
            <el-button type="primary" @click="recordQuery">回放视频查询</el-button>
          </div>
          <div class="playerTool-item flex-box">
            <div class="text">回放列表</div>
            <el-select
            ...
            <el-button type="primary" @click="recordOpenPlay">回放视频播放</el-button>
            <el-button type="primary" @click="recordOpenStop">回放视频播放</el-button>
          </div>
        </div>
      </div>
    </div>
    ...
    <el-button type="primary" @click="handleChange"> 测试 </el-button>
    <el-button type="primary" @click="handleClick"> 获取当前组件内容 </el-button>

    <transition name="fade-transform" mode="out-in">
      <CubeAsyncComs ref="CubeAsyncComs" shiliangl="shiliangl" :file-path="path" />
    </transition>
